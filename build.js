...
const data = {
  name: chalk.white('               Andrew Byrd'),
  handle: chalk.white('wordythebyrd'),
  work: chalk.white('Senior Software Engineer at PayScale'),
  opensource: chalk.white('Massive Nerds - RetroMatic'),
  twitter: chalk.gray('https://twitter.com/') + chalk.cyan('wordythebyrd'),
